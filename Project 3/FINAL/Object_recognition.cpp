...
//    // Implement your logic here to map labels to indices
//    // For example, if your labels are strings like "cat", "dog", "bird", etc.,
//    // you could assign indices like 0, 1, 2, etc.
//    // This is just a placeholder implementation. You should adapt it to your specific use case.
//    if (label == "watch") {
//        return 0;
//    }
//    else if (label == "huskytoy") {
//        return 1;
//    }
...
//    }
//    else {
//        // Handle unknown labels or other cases
//        return -1; // Placeholder value, you should handle this case appropriately
//    }
//}
//// Function to update confusion matrix
//void updateConfusionMatrix(cv::Mat& confusionMatrix, const std::string& trueLabel, const std::string& classifiedLabel, bool correctClassification) {
//    // Your implementation of confusion matrix update goes here
//    int trueIndex = labelToIndex(trueLabel); // Assuming you have a function to convert label to index
//    int classifiedIndex = labelToIndex(classifiedLabel); // Assuming you have a function to convert label to index
//
...
//                    // Print userFeedbacks
//                    cout << "userFeedbacks:" << endl;
//                    for (const auto& feedback : userFeedbacks) {
//                        cout << "True Label: " << feedback.first << ", Classified Label: " << feedback.second << endl;
//                    }
//
...
//
//                    // Check if we're done with confusion mode
//                    if (userFeedbacks.size() >= max_img_class * num_classes) {
//                        cout << "Exiting confusion mode..." << endl;
//                        break; // Break out of the loop if maximum images per class is reached
//                    }
//                }
//            }
...
//        
//        
//        // Other key events handling remains unchanged
//    }
//
//    cap.release();
//    outputFile.close(); // Close the output file when done
...
//////    features["centroid_x"] = xc;
//////    features["centroid_y"] = yc;
//////    features["angle_of_least_central_moment"] = alpha;
//////    features["percent_filled"] = percent_filled;
//////    features["bounding_box_height_width_ratio"] = height / width;
//////
//////    return features;
//////}
//////
...
//////
//////int main() {
//////    const string datasetPath = "D:\\Semester 2\\Pattern Recognition & Computer Vision\\project 3\\new folder\\task3\\task3\\watch"; // Change this to your dataset directory path
//////    const string outputFilepath = "data.csv";
//////
//////    ofstream outputFile(outputFilepath, ios::app);
//////    if (!outputFile.is_open()) {
//////        cerr << "Error: Unable to open " << outputFilepath << " for writing.\n";
//////        return -1;
//////    }
//////
//////    // Use Windows API to iterate over files in the directory
//////    WIN32_FIND_DATAW FindFileData;
//////    HANDLE hFind;
//////
//////    wstring searchPath = wstring(datasetPath.begin(), datasetPath.end()) + L"\\*"; // Convert narrow to wide string
...
//////            string filePath = string(datasetPath) + "\\" + string(reinterpret_cast<const char*>(FindFileData.cFileName));
//////
//////            Mat frame = imread(filePath, IMREAD_COLOR);
//////            if (frame.empty()) {
//////                cerr << "Error: Unable to read image " << filePath << endl;
//////                continue;
//////            }
//////
//////            Mat grayFrame;
...
//////                    }
//////                    saveObjectData(label, features, outputFile);
//////                    label.clear(); // Clear label for the next object
//////                }
//////
...
//////            char key = waitKey(0);
//////            if (key == 't' || key == 'T') {
//////                mode = 't'; // Switch to training mode
//////            }
//////            else {
//////                mode = 'n'; // Switch back to normal mode
//////            }
//////        }
